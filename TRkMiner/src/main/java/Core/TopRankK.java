...
public class TopRankK {
    static Logger logger = Logger.getLogger(TopRankK.class.getName());
...
//        Graph G = new InitGraph().getGraphFromPath("src/main/java/Datasets/facebookcmp.txt");
        ...
        FrequentEdgePatternResult frequentEdgePatternResult = GetInfoFromGraph.getAllEdgePattern(G);
...
//        System.out.println(frequentEdgePatternResult.getFrequentEdgePattern().size());
        ...
        //*********************************************[Forward]*********************************
        ArrayList<ArrayList<Pattern>> patternTree = ForwardTreeGen.newRun(G, frequentEdgePatternResult);
...
//        final int forwardPatternTreeHeight = patternTree.size();
        ...
        ArrayList<ArrayList<Pattern>> backwardPattern = BackwardTreeGenWithEarlyStop.run(G, patternTree, frequentEdgePatternResult);
       ...
       //*********************************************[check by forward]*********************************
//        TopKList topKPattern = BackwardTreeGenWithEarlyStop.topKPattern;
//        patternTree.forEach(patterns -> {
//            for (Pattern pattern : patterns) {
//                if (pattern.getItr() < topKPattern.getMinimumItr()) break;
//                topKPattern.insert(pattern);
//            }
//        });
...
//            System.out.println(k + ":" + topK.get(k).size());
            topK.get(k).forEach(pattern -> logger.error(k+" "+pattern));
