...
import Core.TopRankK_core.TopRankK;
...
public class SkipList {
    ...
    public float getMinimum() {
        ...
        return head.forwards[0].getData();
    }
    ...
    public void printAll() {
        Node p = head;
        Logger logger = Logger.getLogger(SkipList.class.getName());
        StringBuilder sb = new StringBuilder();
        sb.append("当前TokK： ");
        while (p.forwards[0] != null) {
            sb.append(p.forwards[0].data + " ");
    ...
    public String toString() {
        ...
        Node p = head;
        while (p.forwards[0] != null) {
            builder.append(p.forwards[0]).append(" ");
            p = p.forwards[0];
        }
